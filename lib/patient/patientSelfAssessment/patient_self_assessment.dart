                            ...
                            return GestureDetector(
                              onTap: () {
                                setState(() {
                                  ...
                                  if (_expandedIndex == index) {
                                    _expandedIndex =
                                        null; // Close if the same container is tapped again
                                  } else {
                                    _expandedIndex =
                                        index; // Open the tapped container and close others
                                  }
                                });
                              },
                              child: AnimatedContainer(
                                        ...
                                        ? [
                                            ...
                                            Padding(
                                              padding: EdgeInsets.only(
                                                left: isExpanded ? 10 : 10.0,
                                              ),
                                              child: Column(
                                                //crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  CommonText(
                                                    text: assessments[index]
                                                        ['title']!,
                                                    fontSize: 24,
                                                    fontFamily: 'Poppins',
                                                    fontWeight: FontWeight.w400,
...
Widget assessmentCard(
    String title, String description, String content, ImagePath) {
  return Container(
    decoration: BoxDecoration(
      color: Colors.white,
      borderRadius: BorderRadius.only(
